> 관련 문서: [[91-application-prep]] · [[92-esg-dpp-roadmap]]
...
**중요한 경계선**: 이건 **데이터 인사이트 툴이지 AI가 디자인·카피를 만들어주는 게 아님** — 이미 스코프에서 제외 확정한 "GenAI 콘텐츠 생성(카피라이팅·룩북 이미지)"과는 명확히 다른 영역. [[21-system-model]] 부록 A의 원칙과 동일하게, **최종 기획 결정은 MD·디자이너가 하고 툴은 근거 데이터만 제공**(Human-in-the-loop 유지)
