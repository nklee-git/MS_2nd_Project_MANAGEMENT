...
> **2026-09-01 확정**: 테넌트 공유 기본(Default) 환경이 아니라, 나경 개인 **Dataverse Developer 환경("2nd_5team")**을 씀 — 공유 기본 환경은 일반 계정에 테이블 생성 권한이 없어서 이 방식으로 우회함(상세: [[1-execution-plan]] 3-1절). 최민·현제 **둘 다 초대 완료** (2026-09-12 확인). 박형준은 간헐적 서브개발자라 별도 초대는 보류(2026-09-17 기준, [[1-execution-plan]] §0-2 참고).
